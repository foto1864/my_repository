...
// customers: residential and business. #include <iomanip>
...
int main()
{
	...
	cout << "Enter account number (an integer): "<< endl;  //Step 2
	cin >> accountNumber; //Step 3
	cout << "Enter customer type: R or r (Residential), B or b (Business): "<< endl;
	...
	switch (customerType)
	{
		case 'r': //Step 6
		case 'R':
		cout << "Enter the number of premium channels: "<< endl; //Step 6a
		cin >> numOfPremChannels; //Step 6b
		cout << endl; 
		amountDue = RES_BILL_PROC_FEES //Step 6c
			+ RES_BASIC_SERV_COST
			+ numOfPremChannels * RES_COST_PREM_CHANNEL;
			cout << "Account number: " << accountNumber << endl; //Step 6d
			cout << "Amount due: $" << amountDue << endl; //Step 6d
			break;
		case 'b': //Step 7
		case 'B':
		cout << "Enter the number of basic service connections: "; //Step 7a
		
		cin >> numOfBasicServConn; //Step 7b
		cout << endl;
		cout << "Enter the number of premium channels: "; //Step 7c
		...
		cout << "Amount due: $" << amountDue << endl; //Step 7f
